...
const uint8_t SPECIAL_OPCODE = 0xCB;
const uint16_t DIV_REGISTER = 0xFF04;
const uint16_t TIMA = 0xFF05;
const uint16_t TMA = 0xFF06;
const uint16_t TAC = 0xFF07;
const uint16_t IE_REGISTER = 0xFFFF;
const uint16_t IF_REGISTER = 0xFF0F;

const uint8_t initialValuesForFFXX[256] = {
...
const uint8_t nintendoTitle[256] = {
