...
public:
    ...
    void updateTimers(int32_t);
    void updateInterrupts(short &);
    void resetDivRegister();
    void resetTimaRegister();
    void setCurrentClockSpeed(const int32_t);
    int32_t getCurrrentClockSpeed() const;
...
private:
    ...
    void checkZeroFlag(const uint8_t);
    void checkZeroFlag(const uint16_t);
    void checkHalfCarryFlag(const uint8_t);
    void checkHalfCarryFlag(const uint16_t, const uint16_t);
    void checkCarryFlag(const uint8_t);
    void checkCarryFlag(const uint16_t);
    ...
    // LD r,r 4
    void load8BitRegister(uint8_t *, const uint8_t);
	...
	void add8BitRegister(uint8_t *accumulator, uint8_t adding);
	...
	void adc8BitRegister(uint8_t *accumulator, uint8_t adding);
    ...
    // 8-bit sub 4 cycles
	void sub8BitRegister(uint8_t *accumulator, uint8_t substract);
	...
	void sbc8BitRegister(uint8_t *accumulator, uint8_t substract);
	...
	void compare8BitRegister(uint8_t accumulator, uint8_t data);
	...
	void increment8BitRegister(uint8_t *);
    ...
    //8 bit decrements
	void decrement8BitRegister(uint8_t *reg);
    ...
    // 8 bits XOR 4 cycles
	void xor8BitRegister(uint8_t *accumulator, const uint8_t data);
    ...
    // 8 bits OR 4 cycles
	void or8BitRegister(uint8_t *accumulator, uint8_t data);
    ...
    // 8 bit and
	void and8BitRegister(uint8_t *accumulator, uint8_t data);
    ...
    void  loadIntoRegister(uint8_t *, const uint8_t);
    ...
    void rlc8bitRegister(uint8_t *);
    void rrc8bitRegister(uint8_t *);
    void rl8bitRegister(uint8_t *);
    void rr8bitRegister(uint8_t *);
    void sla8bitRegister(uint8_t *);
    void swap8bitRegister(uint8_t *);
    void sra8bitRegister(uint8_t *);
    void srl8bitRegister(uint8_t *);
    ...
    void bit(const uint8_t, const short);
    void set(uint8_t *,const short);
    void res(uint8_t *, const short);
