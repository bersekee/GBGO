...
//////////////////////////////////////////// 8 bits load
void CPU::loadRegister(uint8_t *reg) {
...
//////////////////////////////////////////////////// LD r,r 4
void CPU::load8BitRegister(uint8_t *reg, const uint8_t data) {
    *reg = data;
}
...
void  CPU::loadIntoRegister(uint8_t *reg, const uint8_t registerA) {
    *reg = registerA;
}
